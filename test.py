...
class TestWinningDiagonally1(unittest.TestCase):
    ...
    def test_check_winning_diagonally1(self):
        ...
        self.assertTrue(self.tie.check_winning_diagonally1(2, 2, 0, self.board,
                                                           c.HUMAN))

    def test_check_winning(self):
        """Test wykrywania wygranej w check_winning()."""
        self.assertTrue(self.tie.check_winning(2, 2, self.board, c.HUMAN))
...
class TestWinningDiagonally2(unittest.TestCase):
    ...
    def test_check_winning_diagonally2(self):
        ...
        self.assertTrue(
            self.tie.check_winning_diagonally2(2, 12, 0, self.board, c.HUMAN))

    def test_check_winning(self):
        """Test wykrywania wygranej w check_winning()."""
        self.assertTrue(self.tie.check_winning(2, 12, self.board, c.HUMAN))
...
class TestWinningHorizontally(unittest.TestCase):
    ...
    def test_check_winning_horizontally(self):
        ...
        self.assertFalse(self.tie.check_winning_horizontally(2, 0, 0, self.board,
                                                             c.COMPUTER))

    def test_check_winning(self):
        """Test wykrywania braku wygranej w check_winning() przy 6 kamieniach."""
        self.assertIsNone(self.tie.check_winning(2, 0, self.board, c.HUMAN))

    def test_end_if_gameover(self):
        """Test wykrywania braku końca gry w end_if_gameover()."""
        self.tie.end_if_gameover(2, 0, self.board)
        self.assertIsNone(self.tie.winner)
...
class TestWinningVertically(unittest.TestCase):
    ...
    def test_check_winning_vertically(self):
        ...
        self.assertFalse(self.tie.check_winning_vertically(10, 2, 0, self.board,
                                                           c.COMPUTER))

    def test_check_winning(self):
        """Test braku wygranej w check_winning() przy 6 kamieniach w linii."""
        self.assertIsNone(self.tie.check_winning(10, 2, self.board, c.HUMAN))

    def test_end_if_gameover(self):
        """Test wykrywania braku końca gry w end_if_gameover()."""
        self.tie.end_if_gameover(10, 2, self.board)
        self.assertIsNone(self.tie.winner)
...
class TestCheckDraw(unittest.TestCase):
    ...
    def test_check_winning(self):
        ...
        self.assertIsNone(self.tie.check_winning(2, 12, self.board, c.HUMAN))

    def test_check_draw(self):
        """Test wykrywania remisu."""
        self.assertTrue(self.tie.check_draw(self.board))
...
class TestChangePlayer(unittest.TestCase):
    ...
    def setUp(self):
        self.tie = Tie(None, None)
        self.tie.next_player = c.COMPUTER

    def test_cange_player(self):
        """Test zmiany gracza."""
        self.assertIsNone(self.tie.change_player())
        self.assertEqual(self.tie.next_player, c.HUMAN)
